...
const examFeatures = [
  ...
  "Personalized reports, exam dashboard and PfMP exam tips included",
];
...
const pfmpExamSimulatorFaqs = [
  {
    ...
    answer:
      "Our PfMP® Exam Simulator is a comprehensive online exam preparation tool designed to replicate the real PfMP® exam experience. It provides full-length practice exams with realistic, scenario-based questions aligned with the latest Exam Content Outline and latest Standard for Porfolio Management. The simulator helps you understand question patterns, exam structure, and timing before exam day.",
  },
  {
    question: "What are the benefits of using the PfMP® Exam Simulator?",
    answer:
  ...
  {
    question: "How will I know when I’m ready to take the PfMP® exam?",
    answer:
  ...
  {
    question: "How often should I use the PfMP® Exam Simulator?",
    answer:
  ...
  {
    question: "What if I have questions about the PfMP® Exam Simulator?",
    answer:
  ...
  return (
    <>
      <NavHeroSection
        ...
        description="Our PfMP® Exam Simulator is aligned with the latest PfMP® Exam Content Outline (ECO) and latest Standard for Porfolio Management. These questions are designed for professionals preparing for certification success. It provides realistic exam simulations, and in-depth explanations to help you understand concepts, apply best practices, and confidently handle situational PfMP-style questions."
        descriptionsecond=""
        sideImage={InnerPage}
      />
      ...
      <AuthorizedTrainingPartner
        title="PfMP® Exam Simulator"
        subtitle="Get Certified for PfMP®, the world’s premier Portfolio Management Certification A realistic, full-length simulation exam designed to help you assess readiness and prepare for the PfMP® certification."
        bullets={[
          {
            text: "Instant access from any web browser",
          },
          {
            text: "Aligned with latest PfMP® Exam Content Outline and Standard for Porfolio Management",
          },
          { text: "Full-length PfMP exam simulations" },
          { text: "500+ realistic practice questions" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] gap-5 lg:gap-10 items-start">
            <div>
              ...
              <p className="text-paragraph text-sm font-normal mt-1 w-full leading-[26px]">
                The PfMP® Exam Simulator is designed to help candidates practice
                under real exam conditions before test day. It offers realistic,
                PfMP®-style mock exams aligned with the latest PMI® Exam Content
                Outline and latest Standard for Porfolio Management. With timed
                exams, detailed explanations, and performance analytics,
                learners can identify weak areas, build exam stamina, and
                develop the PMI® mindset required to succeed. This simulator
                ensures confident, focused preparation for passing the PfMP®
      ...
      <section className="bg-white pb-10 lg:pt-0 lg:pb-20">
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className=" flex flex-col justify-center items-center mb-6 md:mb-7 text-center">
            <h2 className="text-Black_light text-2xl md:text-3xl font-bold md:leading-[46px]">
              Why Choose Our PfMP® Exam Simulator?
            </h2>
          </div>
      ...
      <TopFooterSection
        content={{
          ...
          description: (
            <>
              Global demand for senior leaders who can align strategy with
              execution continues to grow. Organizations need experienced
              professionals who can prioritize investments, balance competing
              demands, and ensure the right initiatives deliver measurable
              value.
              <br />
              <br />
              The PfMP® certification is designed for executives and senior
              practitioners managing portfolios of projects, programs, and
              operations aligned with organizational strategy. Strengthening
              your credentials today positions you for tomorrow’s leadership
              opportunities.
            </>
          ),
          pointsIntro:
