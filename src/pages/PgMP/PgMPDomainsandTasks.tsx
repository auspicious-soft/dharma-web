  ...
  cards: [
    {
      ...
      description:
        "Ensure programs remain aligned with organizational strategy and deliver sustained business value.",
    },
    {
      id: 2,
      icon: DetailIcon,
      ...
      description:
        "Lead the program through initiation, planning, execution, transition, and closure.",
    },
    {
      id: 3,
      icon: ImproveIcon,
      ...
      description:
        "Identify, optimize, realize, and sustain benefits that justify program investment.",
    },
    {
      id: 4,
      icon: ComIcon,
      ...
      description:
        "Build strong stakeholder alignment, commitment, and support to achieve successful outcomes.",
    },
    {
      id: 5,
      icon: HatIcon,
...
const whyThisHelps = [
  "Simplifies the PgMP ECO, making it easier to understand and interpret",
...
const PgMPDomainsandTasks = () => {
  return (
    <>
      <NavHeroSection
        title="PgMP®Domains and Tasks - Your Path to Exam Success"
        description="Our PgMP®Domains and Tasks course is aligned with the latest PMI PgMP Exam Content Outline (ECO) and designed for professionals preparing for certification success. The course provides detailed explanations of every domain task, including key words, practical examples, and real-world program management scenarios to build deep understanding."
        ...
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className="flex flex-col justify-start items-start gap-3 text-left">
            <h2 className="text-Black_light text-2xl md:text-3xl font-bold md:leading-[46px]">
              Understand What the PgMP®Exam Really Tests
            </h2>
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              The PgMP exam is structured around the Exam Content Outline (ECO),
              which defines the knowledge, skills, and behaviors program managers
              must demonstrate. A strong understanding of the PgMP Domains,
              Tasks, and Enablers is essential for success, as every exam
              question is aligned to this framework.
            </p>
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              This page breaks down the ECO in a clear and practical way, helping
              you understand what to study, why it matters, and how these concepts
        ...
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className="flex flex-col justify-start items-start gap-3 text-left">
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              ...
              to full exam simulations. A strong understanding of the PgMP
              Domains, Tasks, and Enablers is essential for success, as every exam
              question is mapped directly to this framework. This page helps you
              break down the ECO clearly so you know what to study, why it
              matters, and how it appears in the exam.
            </p>
      ...
      <section className="py-10 md:py-14 lg:py-20">
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className="flex flex-col justify-start items-start gap-3 text-left">
            <h2 className="text-Black_light text-2xl md:text-3xl font-bold md:leading-[46px]">
              What Is the PgMP®Exam Content Outline (ECO)?
            </h2>
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              The PMI Exam Content Outline (ECO) is the official framework behind
              the PgMP exam. It defines the core Domains, Tasks, and
              responsibilities that experienced program managers are expected to
              demonstrate in real-world environments. Every exam question is built
              around this framework, making the ECO essential for focused and
              effective preparation.
            </p>
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              In this section, you will explore each domain in detail, understand
              every task clearly, and learn how these areas are tested through
              situational and scenario-based questions. You'll also gain practical
              examples, key insights, and targeted practice questions to
              strengthen your knowledge and boost exam confidence.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-5 md:gap-7 items-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <h3 className="text-primary_heading text-lg md:text-2xl font-bold">
                PgMP Domains and Tasks: Your Roadmap to Exam Success
              </h3>
              <p className="text-paragraph text-sm font-normal leading-[26px]">
                Explore the key domains and tasks essential for exam success.
              </p>
              <p className="text-paragraph text-sm font-normal leading-[26px]">
                Discover how to turn the PgMP ECO into a practical study roadmap.
              ...
              <Button className="w-fit mt-1" asChild>
                <a href={getSubscriptionUrl("PgMP")}>Get Started</a>
              </Button>
            </div>
          </div>
        </div>
...
export default PgMPDomainsandTasks;
