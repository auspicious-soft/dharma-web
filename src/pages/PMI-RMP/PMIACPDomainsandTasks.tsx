  ...
  cards: [
    {
      ...
      description:
        "Establish the risk management approach, governance, thresholds, and plans.",
    },
    {
      id: 2,
      icon: DetailIcon,
      ...
      description:
        "Identify threats, opportunities, assumptions, triggers, and uncertainties that may impact project objectives.",
    },
    {
      id: 3,
      icon: LineCahrtIcon,
      title: "Risk Analysis",
      description:
        "Evaluate and prioritize risks using qualitative and quantitative techniques.",
    },
    {
      id: 4,
      icon: ImproveIcon,
      title: "Risk Response",
      description:
        "Develop and implement response strategies to address threats, exploit opportunities, and optimize outcomes.",
    },
    {
      id: 5,
      icon: ComIcon,
      ...
      description:
        "Track risks, reassess effectiveness of responses, communicate status, capture lessons learned, and formally close risks.",
    },
  ],
};

const whyThisHelps = [
  "Simplifies the PMI-RMP ECO, making it easier to understand and interpret",
...
const PMIACPDomainsandTasks = () => {
  ...
  return (
    <>
      <NavHeroSection
        title="PMI-RMP® Domains and Tasks"
        description="PMI-RMP® Domains and Tasks - Master Risk Management by Domains"
        descriptionsecond="Prepare confidently for the PMI Risk Management Professional (PMI-RMP®) certification exam with structured learning focused on the domains and tasks outlined in the latest PMI Examination Content Outline (ECO). Strengthen your risk management knowledge, reinforce key concepts, and improve readiness through a systematic approach to each domain. This course is designed to help you understand what PMI expects across every domain and task area for maximum success."
        sideImage={InnerPage}
      />
        ...
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className="flex flex-col justify-start items-start gap-3 text-left">
            <h2 className="text-Black_light text-2xl md:text-3xl font-bold md:leading-[46px]">
              Understand What the PMI-RMP® Exam Really Tests
            </h2>
            ...
            <p className="text-paragraph text-sm font-normal leading-[26px]">
              ...
              to full exam simulations. A strong understanding of the PMI-RMP®
      ...
      <section className="bg-light-blue py-10 md:py-14 lg:py-20">
        <div className="max-w-[1226px] w-full px-3 md:px-4 m-auto">
          <div className="flex flex-col justify-start items-start gap-3 text-left">
            <h2 className="text-Black_light text-2xl md:text-3xl font-bold md:leading-[46px]">
              What Is the PMI-RMP® Exam Content Outline (ECO)?
            </h2>

            <p className="text-paragraph text-sm font-normal leading-[26px]">
              The PMI® Exam Content Outline serves as the foundation of the
              PMI-RMP® exam. It organizes the exam into key Domains, each
              containing specific Tasks and supporting Enablers that reflect
              real-world risk management responsibilities.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-5 md:gap-7 items-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <h3 className="text-primary_heading text-lg md:text-2xl font-bold">
                PMI-RMP® Domains and Tasks: Your Roadmap to Exam Success
              </h3>
              <p className="text-paragraph text-sm font-normal leading-[26px]">
                Explore the key domains and tasks essential for exam success.
              </p>
              <p className="text-paragraph text-sm font-normal leading-[26px]">
                Discover how to turn the PMI-RMP® ECO into a practical study
              ...
              <Button
                ...
                onClick={() => navigate("/PMI-RMP/PMI-RMP-exam-prep-course")}
              >
                Get Started
              </Button>
            </div>
