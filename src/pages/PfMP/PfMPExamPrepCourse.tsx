...
import InnerPage from "@/assets/PfMPExamPrep/PfMPExamPrepHeroBanner.png";
import TrainingImage from "@/assets/PfMPExamPrep/PfMPExamPrepPMIATP.png";
...
import InnerImage from "@/assets/PfMPExamPrep/PfMPExamPrepHeroBanner.png";
...
const access = {
  ...
  cards: [
    ...
    },
    {
      ...
      description:
        "Practice individual PfMP domains to strengthen weak knowledge areas effectively.",
    },
    {
      id: 3,
      icon: LineCahrtIcon,
  ...
  card: [
    {
      ...
      description:
        "Easy-to-follow videos simplify complex PfMP concepts for all experience levels.",
    },
    {
      id: 2,
      title: "PMI®-aligned PfMP simulators",
      description:
    ...
    {
      id: 6,
      title: "Trusted by PfMP aspirants worldwide",
      description:
        "Join thousands of professionals who rely on vCare for PfMP exam success.",
    },
  ],
};
    ...
    <>
      ...
      <div className="bg-light-blue">
        <VideoSection
          ...
          title={
            <>
              Check out the <br /> PfMP Exam Simulator in action.
            </>
          }
...
export default PfMPExamPrepCourse;
